...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return a list of {@link Earthquake} objects that has been built up
     * from parsing a JSON response.
     */
    ...
    /**
     * Return a list of {@link Earthquake} objects by parsing out information
     * about the list of earthquakes from the input earthquakeJSON string.
     */
    private static List<Earthquake> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for(int i = 0; i < jsonFeaturesArray.length(); i++) {
                ...
                String city = jsonPropertiesObject.getString("place");
                long date = jsonPropertiesObject.getLong("time");
