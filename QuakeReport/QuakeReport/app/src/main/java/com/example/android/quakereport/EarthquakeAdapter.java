...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (location.contains(LOCATION_SEPARATOR)) {
            ...
            String distance = parts[0] + LOCATION_SEPARATOR; // 74km NW of
            String city = parts[1]; // Tokyo, Japan

            distanceTextView.setText(distance);
            cityTextView.setText(city);

        } else {
            distanceTextView.setText(R.string.near_the);
    ...
    /**
     * Return the background color of the magnitude.
    ...
    private int getMagnitudeColor(double magnitude) {
        ...
        //Convert the color resource ID into a color integer value using getColor.
